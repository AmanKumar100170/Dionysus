...
const CodeReferences = ({ filesReferences, codeHeight }: Props) => {
    ...
    return (
        <div className="max-w-[70vw]">
            <Tabs value={tab} onValueChange={setTab}>
                ...
                {filesReferences.map(file => (
                    <TabsContent key={file.fileName} value={file.fileName} className={`max-h-[${codeHeight}vh] overflow-scroll max-w-7xl rounded-md`}>
